...
#pizza_names=['pepperoni', 'cheese', 'hawaiian', 'veggie']
#for pizzas in pizza_names:
    #print(pizzas)
    #print(f'My favorite pizza is {pizzas}')
#print('Pizza is one of my favorite foods')

animals=['tiger', 'lion', 'cheetah', 'jaguar']
#for animal in animals:
    #print(animal)
    #print(f'A {animal} would be a great pet')
#print('All these animals are large cats')
print(animals[0:3])